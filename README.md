...
* 평가용 언어모델을 구동할 수 있어야 합니다. (평가용 언어모델 예시: ChatGPT API, Gemini API, LLaMa-2, LLaMa-3, LLaMa-3.1 등)
...
* 한국어 생성 문서의 원소 사실 관계에 대한 설명 기술 [Online] [https://github.com/ETRI-XAINLP/KorFactScore](https://github.com/ETRI-XAINLP/KorFactScore)
